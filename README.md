...
```bash
# from main
pip install git+https://<your-gitlab-pat>@gitlab.globeoss.com/general/libraries/python-http-retryable-client.git

# from a specific branch (eg development)
pip install git+https://<your-gitlab-pat>@gitlab.globeoss.com/general/libraries/python-http-retryable-client.git@development
```
